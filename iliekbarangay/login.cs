    ...
    public partial class login : Form
    {
        ...
        {    
                ...
                else
                {
                    ...
                    staffCMD.CommandText = "update staff set staff_age = datediff(YY, staff_dob,GETDATE())";
                    staffCMD.Connection = Connection.con;
                    staffCMD.ExecuteNonQuery();
                    SqlCommand resCMD = new SqlCommand();
                    resCMD.CommandText = "update resident set resident_age = datediff(YY, resident_dob,GETDATE())";
